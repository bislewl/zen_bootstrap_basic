...
$module_constant = 'CHECKOUT_RELOADED_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/checkout_reloaded'; // This is the directory your installer is in, usually this is lower case
$module_name = "Zen Cart Checkout Reloaded"; // This should be a plain English or Other in a user friendly way
