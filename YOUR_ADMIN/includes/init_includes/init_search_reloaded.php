<?php
/**
 *  init_search_reloaded.php
 *
 * @copyright Copyright 2003-2018 Zen Cart Development Team
 * @copyright Portions Copyright 2003 osCommerce
 * @license http://www.zen-cart.com/license/2_0.txt GNU Public License V2.0
 * @version Author: bislewl  1/11/2018 12:28 PM Modified in yogalifestyle
 */
...
$module_constant = 'SEARCH_RELOADED_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/search_reloaded'; // This is the directory your installer is in, usually this is lower case
$module_name = "Search Reloaded"; // This should be a plain English or Other in a user friendly way
