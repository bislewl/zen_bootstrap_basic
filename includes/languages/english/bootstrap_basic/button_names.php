...
define('BUTTON_IMAGE_PRINT_CART', 'button_shipping_estimator.gif');
...
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Shipping Cost');
define('BUTTON_PRINT_CART_ALT', 'Print this Page');
