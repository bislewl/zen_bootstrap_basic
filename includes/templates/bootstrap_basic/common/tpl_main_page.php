...
?>
<body id="<?php echo $body_id . 'Body'; ?>"<?php if($zv_onload != ''){
	echo ' onload="' . $zv_onload . '"';
} ?>>
...
<div id="mainWrapper" class="<?php echo BOOTSTRAP_BASIC_CONTAINER; ?>">
    <div class="row">
		...
		if((!isset($flag_disable_left) || !$flag_disable_left) && BOOTSTRAP_BASIC_COL_ONE_CLASS != '0'){
			?>
		...
		if((!isset($flag_disable_right) || !$flag_disable_right) && BOOTSTRAP_BASIC_COL_THREE_CLASS != '0'){
			?>
