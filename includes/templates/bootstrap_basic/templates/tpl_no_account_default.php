...
<div id="checkoutButtons">
  <div id="checkoutButton" class="buttonRow forward"><button type="submit" class="btn btn-success btn-lg">Continue</button></div>
