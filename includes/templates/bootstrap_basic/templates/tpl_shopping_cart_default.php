 ...
 * @version Author: bislewl  4/10/2016 9:42 PM Modified in zen_bootstrap_basic
 */
?>
...
<?php
  if ($flagHasCartContents) {
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="shoppingCartButtons">
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              <?php echo zen_back_link() . '<button type="button" class="btn btn-success btn-lg">Back to Shopping</button>'. '</a>'; ?>
          </div>

          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              <div class="buttonRow back"><?php echo '<a href="javascript:popupWindow(\'' . zen_href_link(FILENAME_POPUP_SHIPPING_ESTIMATOR) . '\')"><button type="button" class="btn btn-success btn-lg">Shipping Estimator</button></a>'; ?></div>
          </div>

          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              <?php echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '"><button type="button" class="btn btn-success btn-lg">Checkout</button></a>'; ?>
          </div>
      </div>
