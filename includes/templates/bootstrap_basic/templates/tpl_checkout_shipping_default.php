...
<div class="buttonRow forward"><button type="submit" class="btn btn-success btn-lg">Continue</button></div>
<div class="buttonRow back"><button type="button" class="btn btn-success btn-lg">Back</button></div>
