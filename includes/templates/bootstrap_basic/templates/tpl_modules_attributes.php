...
<?php } // show please select unless all are readonly ?>
    <div class="wrapperAttribsOptions col-sm-12">
        <h4 class="optionName back"><label class="attribsSelect" for="productQty">Quantity</label></h4>
        <div class="back">
            <div class="form-group">
                <label></label><br/>
                <input id="productQty" class="form-control" type="text"
                       data-provide="slider"
                       data-slider-ticks="[1,2,3,4,5,6]"
                       data-slider-ticks-labels='["1", "50", "100", "250", "500", "1000"]'
                       data-slider-min="1"
                       data-slider-max="6"
                       data-slider-step="1"
                       data-slider-value="1"
