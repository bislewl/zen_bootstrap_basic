...
<?php if (COWOA_STATUS == 'true') { ?>
    ...
    <?php echo "<a href=\"" . zen_href_link(FILENAME_NO_ACCOUNT, '', 'SSL') . "\">"; ?>
        <button type="button" class="btn btn-success btn-lg">Continue</button></a></div>
    <br class="clearBoth" />
    </fieldset>
  <?php } ?>
<!-- BOF COWOA -->
...
<br class="clearBoth" />
<br class="clearBoth" />
<div class="buttonRow forward"><button type="submit" class="btn btn-success btn-lg">Login</button></div>
...
<div class="buttonRow forward"><button type="submit" class="btn btn-success btn-lg">Create Account</button></div>
</form>
</fieldset>
<br class="clearBoth" />
...
<div class="buttonRow forward"><button type="submit" class="btn btn-success btn-lg">Login</button></div>
<div class="buttonRow back important"><?php echo '<a href="' . zen_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '"><button type="button" class="btn btn-default btn-lg">Forgot Password</button></a>'; ?></div>
</form>
<br class="clearBoth" />
